...
if ( ! function_exists( 'basic_setup' ) ) :
	function basic_setup() {
		...
		register_nav_menus( array(
            ...
            'menu-item-1' => esc_html__( 'Footer Item 1', 'basic' ),
            'menu-item-2' => esc_html__( 'Footer Item 2', 'basic' ),
            'menu-item-3' => esc_html__( 'Footer Item 3', 'basic' )
		) );
...
function basic_footer3_widgets_init() {
    register_sidebar( array(
        'name'          => esc_html__( 'Footer-3', 'basic' ),
        'id'            => 'footer-3',
        'description'   => esc_html__( 'Add widgets here.', 'basic' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'basic_footer3_widgets_init' );
